...
const MIDI_Program cgm::midi_programs[] =
{
    ...
    {74, "Flute",                           {"C4",  "C7"}},
    {75, "Recorder",                        {"C-1", "G#9"}},
    {76, "Pan Flute",                       {"C-1", "G#9"}},
    {77, "Blown bottle",                    {"C-1", "G#9"}},
    {78, "Shakuhachi",                      {"C-1", "G#9"}},
    {79, "Whistle",                         {"C-1", "G#9"}},
    {80, "Ocarina",                         {"C-1", "G#9"}},
    // Synth Lead
    ...
    {112, "Shanai",                         {"Bb3", "G6"}},
    // Percussive
    {113, "Tinkle Bell",                    {"C-1", "G#9"}},
    {114, "Agogô",                          {"C-1", "G#9"}},
    {115, "Steel Drums",                    {"C-1", "G#9"}},
    {116, "Woodblock",                      {"C-1", "G#9"}},
    {117, "Taiko Drum",                     {"C-1", "G#9"}},
    {118, "Melodic Tom",                    {"C-1", "G#9"}},
    {119, "Synth Drum",                     {"C-1", "G#9"}},
    {120, "Reverse Cymbal",                 {"C-1", "G#9"}},
    // Sound Effects
    {121, "Guitar Fret Noise",              {"C-1", "G#9"}},
    {122, "Breath Noise",                   {"C-1", "G#9"}},
    {123, "Seashore",                       {"C-1", "G#9"}},
    {124, "Bird Tweet",                     {"C-1", "G#9"}},
    {125, "Telephone Ring",                 {"C-1", "G#9"}},
    {126, "Helicopter",                     {"C-1", "G#9"}},
    {127, "Applause",                       {"C-1", "G#9"}},
    {128, "Gunshot",                        {"C-1", "G#9"}},
    // Idiophones
