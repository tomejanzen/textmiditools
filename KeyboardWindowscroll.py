...
class KeyboardFrame(tkinter.Frame):
    ...
    def __init__(self, parent):
        ...
        self.canvas = Canvas(self.frame, bg='white', scrollregion=(0, 0, self.canvas_width, self.canvas_height), height=self.canvas_height, width=self.canvas_width / 2, background='#88AAFF', xscrollcommand=self.scrollbar.set)
        self.scrollbar['command'] = self.canvas.xview
        self.scrollbar.grid(column=0, row=1, sticky=(W,E))
    ...
    def draw_keyboard(self):
        ...
        white_key_width = self.canvas_width / self.number_of_white_keys
        resize_scale = white_key_width / self.one_octave.white_key_width
        self.full_keyboard = []
        self.one_octave.scale(resize_scale)
        #self.one_octave.scale(.25)
        win_height = self.one_octave.keys[0][2][1][1]
        win_width = self.one_octave.keys[0][2][2][1] * self.number_of_white_keys
