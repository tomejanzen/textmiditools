...
am_miditext_OBJECTS = miditext.$(OBJEXT) Midi.$(OBJEXT) \
	MidiMessages.$(OBJEXT) MIDIKeyString.$(OBJEXT)
miditext_OBJECTS = $(am_miditext_OBJECTS)
miditext_LDADD = $(LDADD)
am_smustextmidi_OBJECTS = smustextmidi.$(OBJEXT) \
	SmusTrackEvent.$(OBJEXT)
smustextmidi_OBJECTS = $(am_smustextmidi_OBJECTS)
smustextmidi_LDADD = $(LDADD)
am_textmidi_OBJECTS = textmidi.$(OBJEXT) Midi.$(OBJEXT) main.$(OBJEXT) \
	miditext.$(OBJEXT)
...
am__depfiles_remade = ./$(DEPDIR)/Composer.Po \
	./$(DEPDIR)/GeneralMIDI.Po ./$(DEPDIR)/GnuPlot.Po \
	./$(DEPDIR)/MIDIKeyString.Po ./$(DEPDIR)/Midi.Po \
	./$(DEPDIR)/MidiMessages.Po ./$(DEPDIR)/MusicalForm.Po \
	./$(DEPDIR)/NoteEvent.Po ./$(DEPDIR)/Scales.Po \
	./$(DEPDIR)/SmusTrackEvent.Po ./$(DEPDIR)/Track.Po \
	./$(DEPDIR)/Voice.Po ./$(DEPDIR)/cgmlegacy.Po \
	./$(DEPDIR)/main.Po ./$(DEPDIR)/miditext.Po \
	./$(DEPDIR)/smustextmidi.Po ./$(DEPDIR)/textmidi.Po \
	./$(DEPDIR)/textmidicgm.Po
am__mv = mv -f
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in AUTHORS \
	...
	install-sh missing texinfo.tex textmidi.c ylwrap
...
AM_CXXFLAGS = -std=c++20 -Wall -Wextra -Weffc++ -g -O2
AM_LFLAGS = -i
LEXFLAGS = -i
LEX = /usr/bin/env lex
all: config.h
...
include ./$(DEPDIR)/MidiMessages.Po # am--include-marker
