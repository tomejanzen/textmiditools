...
const ArrangementDefinition& MusicalForm::arrangement_definition() const noexcept
{
    return arrangement_definition_;
}
...
void MusicalForm::random(string formname, int32_t instrument_flags)
{
    ...
    copyright_ = string("This form was generated by textmidicgm using random numbers.");

    len_  = 1800;
    min_note_len_ = 0.03125 + rd();
    ...
    arrangement_definition().algorithm(static_cast<arrangements::PermutationEnum>(ri() % 10 + 1));
