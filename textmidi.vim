...
syntax keyword midiEvent FILEHEADER TEXT COPYRIGHT TRACK END_OF_TRACK INSTRUMENT LYRIC MARKER CUE_POINT TEMPO STARTTRACK NOTE_ON NOTE_OFF POLY_KEY_PRESSURE CONTROL RESETALL ALLNOTESOFF PAN BREATH DAMPER SOFTPEDAL PORTAMENTO SOSTENUTO PROGRAM CHANNEL_PRESSURE PITCH_WHEEL TIME_SIGNATURE KEY_SIGNATURE DYNAMIC DELAY MIDI_PORT MIDI_CHANNEL ALLNOTES_OFF ALL_SOUND_OFF
